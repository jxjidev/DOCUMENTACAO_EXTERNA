...
\- Evidências (prints, logs, mensagens de erro)\
\- Ambiente impactado\
\- Nome e contato do solicitante

| **Complexidade** | **Tempo Máximo de Resposta** | **Responsável** | **Descrição**                                                                          |
| ---------------- | ---------------------------- | --------------- | -------------------------------------------------------------------------------------- |
| **Baixa**        | Até 3 horas úteis            | Suporte N1      | Dúvidas simples, ajustes menores ou requisições que não comprometem a operação.        |
| **Média**        | Até 8 horas úteis            | Suporte N2      | Análises técnicas mais detalhadas, com impacto moderado em partes da operação.         |
| **Alta**         | Até 24 horas úteis           | Suporte N2      | Incidentes críticos, de alta complexidade, que exigem uma análise técnica aprofundada. |



### **Condições de Pausa de SLA**
...
* Ações recomendadas
* Status de SLA: Pausado até retorno do cliente
